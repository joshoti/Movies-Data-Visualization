...
export function ChatSpace() {
  const sampleMessages = [
    ...
    { role: "agent", message: "Here's how we can approach the Semantic Data Model (SDM) and the Enhanced Entity-Relationship Data Model (ERDM) for a database involving students enrolling in courses and professors teaching those courses: Semantic Data Model (SDM) In a Semantic Data Model, the entities and their relationships are represented in a simple and intuitive manner to capture the meaning behind the data. Here's an SDM representation of this system:" },
  ];
